...
function calcularPiso() {
  ...
  $("#result").html(
    `Quantidade <strong>aproximada</strong> de peças necessárias ${$("#loss-percent-button").is(":checked")
...
function calcularTinta() {
  ...
  /* imprimindo o resultado */
  $("#tint-result").html(
    `Quantidade <strong>aproximada</strong> de litros necessários ${$("#tint-loss-percent-button").is(":checked")
      ? ", considerando a taxa de perda"
      : ""
    } : ${finalValue}L`
  );
...
function calcularTelha() {
  ...
  /* imprimindo o resultado */
  $("#tile-result").html(
    `Quantidade <strong>aproximada</strong> de telhas necessárias ${$("#tile-loss-percent-button").is(":checked")
      ? ", considerando a taxa de perda"
      : ""
